		...
		return (
			<div className="row">
				...
				<div className="row form-group">
					<div className="row">
						<label className="white-text">Neurological</label>
					</div>
					<div className="row">
				...
				<div className="row form-group">
					<div className="row">
						<label  className="white-text">Vascular</label>
					</div>
					<div className="row">
						<textarea cols={70} rows={4}
							onChange={(e) => this.props.onChange(e)}
				...
				<div className="row form-group">
					<div className="row">
						<label  className="white-text">Skin temperature</label>
					</div>
					<div className="row">
						<textarea cols={70} rows={4}
							onChange={(e) => this.props.onChange(e)}
				...
				<div className="row form-group">
					<div className="row">
						<label  className="white-text">Foot pressures</label>
					</div>
					<div className="row">
						<textarea cols={70} rows={4}
							onChange={(e) => this.props.onChange(e)}
