    ...
    return (
      <div className="row">
        ...
        <div className="row form-group">
          <div className="row">
            <label htmlFor="ck11" className="white-text">Full blood count</label>
          </div>
          <div className="row">
            <input type="text" 
        ...
        <div className="row form-group">
          <div className="row">
            <label htmlFor="ck11" className="white-text">Serum electrolytes, urea and creatinine</label>
          </div>
          <div className="row">
            <input type="text" 
              onChange={(e) => this.props.onChange(e)}
        ...
        <div className="row form-group">
        <div className="row">
          <label htmlFor="ck11" className="white-text">Blood glucose and HbAlc</label>
        </div>
        <div className="row">
          <input type="text" 
            onChange={(e) => this.props.onChange(e)}
      ...
      <div className="row form-group">
          <div className="row">
            <label htmlFor="ck11" className="white-text">Serum bilirubin, alkaline phosphatase, gamma glutamyl transferase, aspartate transaminase</label>
          </div>
          <div className="row">
            <input type="text" 
              onChange={(e) => this.props.onChange(e)}
        ...
        <div className="row form-group">
          <div className="row">
            <label htmlFor="ck11" className="white-text">Serum cholesterol and triglycerides</label>
          </div>
          <div className="row">
            <input type="text" 
              onChange={(e) => this.props.onChange(e)}
